...
public class FastDateParser implements DateParser, Serializable {
    ...
    private class StrategyParser {
        ...
        private StrategyAndWidth letterPattern(final char c) {
            ...
            return new StrategyAndWidth(getStrategy(c, width, this.definingCalendar), width);
        }
        ...
        private StrategyAndWidth literal() {
            ...
            while (this.currentIdx < FastDateParser.this.pattern.length()) {
                ...
                if (!activeQuote && isFormatLetter(c)) {
                    break;
                } else if (c == '\'' && (++this.currentIdx == FastDateParser.this.pattern.length() || FastDateParser.this.pattern.charAt(this.currentIdx) != '\'')) {
    ...
    //-----------------------------------------------------------------------
    /* (non-Javadoc)
     * @see com.hsjawanda.gaeobjectify.repackaged.commonslang3.time.DateParser#getPattern()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.hsjawanda.gaeobjectify.repackaged.commonslang3.time.DateParser#getTimeZone()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.hsjawanda.gaeobjectify.repackaged.commonslang3.time.DateParser#getLocale()
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.hsjawanda.gaeobjectify.repackaged.commonslang3.time.DateParser#parseObject(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.hsjawanda.gaeobjectify.repackaged.commonslang3.time.DateParser#parse(java.lang.String)
     */
    @Override
    ...
    /* (non-Javadoc)
     * @see com.hsjawanda.gaeobjectify.repackaged.commonslang3.time.DateParser#parseObject(java.lang.String, java.text.ParsePosition)
     */
    @Override
     ...
     *
     * @see com.hsjawanda.gaeobjectify.repackaged.commonslang3.time.DateParser#parse(java.lang.String, java.text.ParsePosition)
     */
    @Override
    ...
    private Strategy getLocaleSpecificStrategy(final int field, final Calendar definingCalendar) {
        ...
        if (strategy == null) {
            strategy = field == Calendar.ZONE_OFFSET
                    ? new TimeZoneStrategy(this.locale)
                    : new CaseInsensitiveTextStrategy(field, definingCalendar, this.locale);
